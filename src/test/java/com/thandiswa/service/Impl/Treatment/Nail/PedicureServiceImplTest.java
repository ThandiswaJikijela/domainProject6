...
public class PedicureServiceImplTest {
    private PedicureRepositoryImpl repository;
    private Pedicure pedicure;

    @Before
    public void setUp() throws Exception {
        this.repository = PedicureRepositoryImpl.getRepository();
        this.pedicure = PedicureFactory.getPedicure("Filing");
    }
    ...
    @Test
    public void update() {
        String newHeelPedicure = "Blading";
